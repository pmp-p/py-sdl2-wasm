...
from sdl2.sdlttf import TTF_FontLineSkip, TTF_OpenFont, TTF_RenderUTF8_Blended
...
async def run():
    ...
    fontpath = byteify(RESOURCES.get_path("tuffy.ttf"))
    _ttf_init()
    ...
    font_col = SDL_Color(*WHITE_RGBA)
    txt_rendered = TTF_RenderUTF8_Blended(font, txt, font_col)
